...
exports.makeRoutes = exports.flattenContent = exports.initGroupAndItemIds = exports.makeNavItems = exports.isExpansion = exports.isModulePageDef = void 0;
var React = require("react");
var react_router_dom_1 = require("react-router-dom");
var react_core_1 = require("@patternfly/react-core");
var Msg_1 = require("./widgets/Msg");
var PageNotFound_1 = require("./content/page-not-found/PageNotFound");
var ForbiddenPage_1 = require("./content/forbidden-page/ForbiddenPage");
;
...
function createNavItems(activePage, contentParam, groupNum) {
    ...
    var links = contentParam.map(function (item) {
        var navLinkId = "nav-link-".concat(item.id);
        if (isExpansion(item)) {
            ...
            var page = item;
            return React.createElement(react_core_1.NavItem, { id: navLinkId, groupId: item.groupId, itemId: item.itemId, key: item.itemId, to: '#/' + page.path, isActive: activePage.itemId === item.itemId, type: "button" }, Msg_1.Msg.localize(page.label, page.labelParams));
        }
    });
...
function makeRoutes() {
    ...
    var routes = pageDefs.map(function (page) {
        if (isModulePageDef(page)) {
            ...
            return React.createElement(react_router_dom_1.Route, { key: page.itemId, path: '/' + page.path, exact: true, render: function () { return node_1; } });
        }
        else {
            var pageDef = page;
            return React.createElement(react_router_dom_1.Route, { key: page.itemId, path: '/' + page.path, exact: true, component: pageDef.component });
        }
    });
    return (React.createElement(react_router_dom_1.Switch, null,
        routes,
        React.createElement(react_router_dom_1.Route, { path: "/forbidden", component: ForbiddenPage_1.ForbiddenPage }),
