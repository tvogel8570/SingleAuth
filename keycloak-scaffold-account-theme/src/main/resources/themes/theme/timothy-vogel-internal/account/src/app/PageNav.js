...
var PageNavigation = /** @class */ (function (_super) {
    ...
    PageNavigation.prototype.findActiveItem = function () {
        ...
        var items = (0, ContentPages_1.flattenContent)(content);
    ...
    PageNavigation.prototype.render = function () {
        ...
        return (React.createElement(react_core_1.Nav, null,
            React.createElement(react_core_1.NavList, null, (0, ContentPages_1.makeNavItems)(activeItem))));
    };
    return PageNavigation;
}(React.Component));
exports.PageNav = (0, react_router_dom_1.withRouter)(PageNavigation);
