...
exports.MyResourcesPage = void 0;
...
var MyResourcesPage = /** @class */ (function (_super) {
    ...
    function MyResourcesPage(props, context) {
        ...
        _this.fetchPending = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.context.doGet("/resources/pending-requests")];
                    case 1:
                        response = _a.sent();
                        resources = response.data || [];
                        resources.forEach(function (pendingRequest) {
        ...
        _this.handleTabClick = function (tabIndex) {
    ...
    MyResourcesPage.prototype.fetchFilteredResources = function (params) {
        if (this.isSharedWithMeTab()) {
            ...
            this.fetchResources("/resources", __assign(__assign({}, params), { first: this.first, max: this.max }));
        }
    };
    ...
    MyResourcesPage.prototype.parseResourceResponse = function (response) {
        var links = response.headers.get('link') || undefined;
        var parsed = (0, ParseLink_1.default)(links);
        var next = '';
        var prev = '';
        if (parsed !== null) {
            if (parsed.next)
    ...
    MyResourcesPage.prototype.makeTab = function (eventKey, title, resources, sharedResourcesTab) {
        return (React.createElement(react_core_1.Tab, { id: title, eventKey: eventKey, title: Msg_1.Msg.localize(title) },
                ...
                React.createElement(react_core_1.StackItem, { isFilled: true },
                    React.createElement(react_core_1.Level, { hasGutter: true },
                        React.createElement(react_core_1.LevelItem, null,
                            React.createElement(react_core_1.TextInput, { value: this.state.nameFilter, onChange: this.handleFilterRequest, id: 'filter-' + title, type: "text", placeholder: Msg_1.Msg.localize('filterByName'), iconVariant: "search" })))),
                React.createElement(react_core_1.StackItem, { isFilled: true },
    ...
    MyResourcesPage.prototype.render = function () {
        ...
        return (React.createElement(ContentPage_1.ContentPage, { title: "resources", onRefresh: this.fetchInitialResources.bind(this) },
            React.createElement(react_core_1.PageSection, { variant: react_core_1.PageSectionVariants.light },
                React.createElement(react_core_1.Tabs, { activeKey: this.state.activeTabKey, onSelect: function (event, index) { return _this.handleTabClick(index); } },
